...
func safeClipboardInit() (err error) {
	defer func() {
		if recover() != nil {
...
func (m *editorModel) AddBinding(binding KeyBinding) {
	m.registry.Add(binding.Key, func(em *editorModel) tea.Cmd {
		...
		if binding.Handler != nil {
			commands = append(commands, binding.Handler(em.GetBuffer()))
		}
		if binding.Mode == ModeVisual && binding.VisualHandler != nil {
			commands = append(commands, binding.VisualHandler(em.GetBuffer().GetRange(em.GetSelectionBoundary())))
		}
